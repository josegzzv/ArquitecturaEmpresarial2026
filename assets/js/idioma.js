...
(function (EA) {
  ...
  */
  ...
  const TEXTOS = {
    ...
    "taller.avisoPrivacidad": ["Tus respuestas se guardan solo en este navegador. No viajan a ningún servidor y el profesor no las ve: al final las copias a Word o las descargas como documento.",
                           "Your answers are stored only in this browser. They never reach a server and the instructor cannot see them: at the end you copy them into Word or download them as a document."],
    ...
    "taller.entregableNota": ["Tu trabajo, ya con formato. Cópialo y pégalo en Word conservando títulos, negritas y tablas, descárgalo como documento, o imprímelo en PDF.",
                           "Your work, already formatted. Copy and paste it into Word keeping headings, bold text and tables, download it as a document, or print it to PDF."],
    "taller.copiarWord":  ["Copiar con formato", "Copy with formatting"],
    "taller.copiado":     ["✓ Copiado — pégalo en Word", "✓ Copied — paste it into Word"],
    "taller.noCopio":     ["No se pudo copiar — selecciónalo a mano", "Copy failed — select it manually"],
    "taller.descargarWord": ["Descargar para Word", "Download for Word"],
    ...
    "taller.presPdf":     ["Guardar la presentación en PDF", "Save the presentation as PDF"],
    "taller.presVacia":   ["Contesta los siete puntos de la etapa 8 y aquí aparecerán como diapositivas.",
                           "Answer the seven points in stage 8 and they will show up here as slides."],
    "taller.cronoTotal":  ["Duración total: {n} {u} · alrededor de {m} meses",
                           "Total duration: {n} {u} · about {m} months"],
    "taller.campoNombre": ["Nombre", "Name"],
    "taller.campoGrupo":  ["Grupo o matrícula", "Group or student ID"],
    "taller.campoFecha":  ["Fecha", "Date"],
    "taller.colConcepto": ["Concepto", "Item"],
    "taller.colValor":    ["Valor", "Value"],
    "taller.sinRespuestas": ["Todavía no has llenado ninguna etapa.",
                             "You have not filled in any stage yet."],
